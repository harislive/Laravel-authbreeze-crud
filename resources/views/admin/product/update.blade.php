<x-admin-layout>
    <div class="card">
        ...
        <form action="{{ route('admin.products.update',$products->id) }}" enctype="multipart/form-data" method="POST" class="container">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea type="text" class="form-control"  name="description" id="description"
                    placeholder="Write Item description" >{{ $products->description }}</textarea>
                <div class="text-danger">
                    @error('description')
                        {{ $message }}
                    @enderror
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="price" value="{{ $products->price }}" id="price" placeholder="Write Item price">
                <div class="text-danger">
                    @error('price')
                        {{ $message }}
                    @enderror
            ...
            <div class="mb-3">
                ...
                <img src="{{ Storage::url($products->image) }}" alt="image" height="100" width="100">
